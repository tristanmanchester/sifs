...
- SIFS full corpus: `repos=63`, `tasks=1251`, `NDCG@10=0.846595064033412`,
  `cold_index_ms=166.47088050119908`,
  `warm_uncached_query_ms=2.6721923541167065`, and
  `warm_cached_repeat_query_ms=0.004887706634692245`.
