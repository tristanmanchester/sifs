...
- SIFS full corpus: `repos=63`, `tasks=1251`, `NDCG@10=0.8109396276912723`,
  `cold_index_ms=169.80463688009587`,
  `warm_uncached_query_ms=4.79014561151079`, and
  `warm_cached_repeat_query_ms=0.005202859312549958`.
