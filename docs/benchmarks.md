...
- SIFS full corpus: `repos=63`, `tasks=1251`, `NDCG@10=0.8471449896076365`,
  `cold_index_ms=167.0321609960032`,
  `warm_uncached_query_ms=2.6578792709832135`, and
  `warm_cached_repeat_query_ms=0.004892182254196643`.
