...
- SIFS full corpus: `repos=63`, `tasks=1251`, `NDCG@10=0.818103060925117`,
  `cold_index_ms=168.81237496402878`,
  `warm_uncached_query_ms=4.162963362110313`, and
  `warm_cached_repeat_query_ms=0.005381682653876899`.
