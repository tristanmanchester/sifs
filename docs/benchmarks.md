...
- SIFS full corpus: `repos=63`, `tasks=1251`, `NDCG@10=0.8451249990627325`,
  `cold_index_ms=182.44255450919266`,
  `warm_uncached_query_ms=2.7292934492406085`, and
  `warm_cached_repeat_query_ms=0.004952705835331733`.
