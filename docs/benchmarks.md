...
- SIFS full corpus: `repos=63`, `tasks=1251`, `NDCG@10=0.8435067836274805`,
  `cold_index_ms=196.6506674804156`,
  `warm_uncached_query_ms=2.883227775379696`, and
  `warm_cached_repeat_query_ms=0.005122156674660271`.
