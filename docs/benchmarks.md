...
- SIFS full corpus: `repos=63`, `tasks=1251`, `NDCG@10=0.8339372695341337`,
  `cold_index_ms=209.8241554436451`,
  `warm_uncached_query_ms=4.762090334932057`, and
  `warm_cached_repeat_query_ms=0.0052014380495603516`.
