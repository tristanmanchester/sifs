...
license: MIT
compatibility: Requires the local `sifs` binary on PATH. Works in portable agent runtimes with shell access on macOS/Linux; MCP tools are optional.
metadata:
  version: "0.1.0"
  variant: "generic-agent-skill"
---
